...
// TODO: del
public class SimpleDeleteServiceOld<I, E extends Entity<I>, D extends Domain<I>, R> implements DeleteServiceOld<I, R>{
    ...
    public SimpleDeleteServiceOld(DeleterByIdOld<I, E> deleterById,
